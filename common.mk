...
PRODUCT_COPY_FILES += \
    ...
    device/oneplus/sm7250-common/configs/vendor.lineage.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor.lineage.biometrics.fingerprint.inscreen.xml
